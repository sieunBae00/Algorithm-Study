...
아래는 `n=2` 일 경우의 재귀 함수 동작을 나타낸 것이다.
<img width="855" height="500" alt="image" src="https://github.com/user-attachments/assets/0918c937-4bc3-47f4-a50d-16d38027a15c" />
</br>
...
```
  ...
  (`make_parentheses(current_str + "(", open-1, close);`)으로 수정했다.  
</br>
